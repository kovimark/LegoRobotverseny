...
const handbookSections = [
  { id: 'intro', title: 'Általános tudnivalók', start: 'Versenyzői kézikönyv2026', end: 'Hegymászás' },
...
const buildSectionContent = (sectionId, text, fallbackTitle) => {
  ...
  const content = []
  let currentItem = { title: fallbackTitle, text: [] }
  ...
  const pushCurrentItem = () => {
    ...
    content.push({
      ...currentItem,
      text: splitParagraphs(currentItem.text.join(' '))
    })
  }
